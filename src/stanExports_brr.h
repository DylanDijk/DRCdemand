...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_brr");
    reader.add_event(30, 28, "end", "model_brr");
    return reader;
}
#include <stan_meta_header.hpp>
class model_brr
  : public stan::model::model_base_crtp<model_brr> {
private:
        int N;
        int K;
        matrix_d x;
        vector_d y;
public:
    model_brr(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_brr_namespace::model_brr";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            stan::math::assign(sigma, (1 / stan::math::sqrt(tau)));
            ...
            lp_accum__.add(gamma_log<propto__>(tau, 2, 0.1));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_brr_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        try {
            ...
            for (int n = 1; n <= N; ++n) {
                ...
                stan::model::assign(y_rep, 
                            ...
                            normal_rng(multiply(get_base1(x, n, "x", 1), beta), sigma, base_rng__), 
...
typedef model_brr_namespace::model_brr stan_model;
#ifndef USING_R
